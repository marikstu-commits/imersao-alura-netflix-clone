...
Dark/Light Mode: Alternância de temas personalizada com salvamento de preferência do usuário.

Design Responsivo: Grid de perfis adaptável para dispositivos móveis (forçado em 2 colunas).
...
JavaScript (ES6+): Manipulação de eventos, LocalStorage e módulos.
...
Responsividade: Controle de quebra de linha em layouts flexíveis para telas pequenas.
